...
export const getSingleEventController = async (req: Request, res: Response) => {
  try {
    const id = req.params.id;
    const event = await EventService.getSingleEventService(id as string);
...
export const updateEventController = async (req: Request, res: Response) => {
  try {
    const id = req.params.id;
    const event = await EventService.updateEventService(id as string, req.body);
...
export const deleteEventController = async (req: Request, res: Response) => {
  try {
    const id = req.params.id;
    const event = await EventService.deleteEventService(id as string);
