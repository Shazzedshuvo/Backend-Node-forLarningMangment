...
const router = Router();
// sucessstory/create"
router.post("/create", validateMiddleware(successStoryValidationSchema), SuccessStoryController.createSuccessStoryController);
...
//# sourceMappingURL=success.routes.js.map